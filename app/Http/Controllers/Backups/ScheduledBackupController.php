...
use App\Models\ApiModels\Backups\ScheduledBackupApiModel;
...
class ScheduledBackupController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        ...
        return new JsonResponse(ScheduledBackupApiModel::fromEntities($scheduledBackups));
    }
    ...
    public function store(ScheduledBackupStoreRequest $request): JsonResponse
    {
        ...
        return new JsonResponse(ScheduledBackupApiModel::fromEntity($scheduledBackup));
    }
