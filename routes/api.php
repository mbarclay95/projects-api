...
use App\Http\Controllers\Grocery\GroceryCategoryController;
...
use App\Http\Controllers\Grocery\RecipeController;
...
// BACKUPS
Route::middleware('auth')->group(function () {
    Route::apiResource('backups', BackupController::class)->except('show');
